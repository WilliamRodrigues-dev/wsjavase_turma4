...
/*
 * Pilares da OO
 * 1º Abstração => efetivamente faça uma análise consistente
 * 2º Encapsulamento => mostre e dê acesso somente o que for necessário
 * 3º Herança => agrupe grupos de objetos, facilitando manutenção e reaproveitamento
 * 4º Polimorfismo => métodos com mesmo e funções distintas. Dois tipos:
 * - Overriding (sobrescrita) => métodos em classes diferentes.
 * - Overload (sobrecarga) => métodos na mesma classe
