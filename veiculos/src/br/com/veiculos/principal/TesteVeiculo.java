...
public class TesteVeiculo {
	...
	public static void main(String[] args) {
		//Montadora montadora = new Montadora("VW","c:","ALEMÃ");
		//montadora.setNome("Volkswagen");
		//montadora.setSimbolo("C:\\montadora");
		//montadora.setNacionalidade("Alemã");
		...
		//Teste getStatus()
		System.out.println("O fusca está em movimento?" + fusca.getStatus());
		//Teste Montadora
